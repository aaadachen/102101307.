...
throwDice2: function () {
  ...
  let num = [1, 2, 3, 4, 6, 9];
  let num1 = Math.floor(Math.random() * num.length) ;
  let bei = num[num1];
  this.setData({
    touziresult2:touziresult,//骰子投掷结果
    finalmagnify2:bei
  })
  // 更新数据，触发界面更新
  this.setData({
    dices2: this.data.dices2,
    allresult2:touziresult,
  });
}
},
...
/*autom2:function(){
  var allresults = this.data.allresult2;
...
autol2:function(){
  ...
  if(this.data.lunnum<3){
    if(allresults[0] == 1 && allresults[1] == 2 && allresults[2] == 3 && allresults[3] == 4 && allresults[4] == 6 || allresults[0] == 1 && allresults[1] == 2 && allresults[2] == 3 && allresults[3] == 4 && allresults[4] == 4 || allresults[0] == 1 && allresults[1] == 2 && allresults[2] == 3 && allresults[3] == 3 && allresults[4] == 4 || allresults[0] == 1 && allresults[1] == 2 && allresults[2] == 2 && allresults[3] == 3 && allresults[4] == 4 || allresults[0] == 1 && allresults[1] == 1 && allresults[2] == 2 && allresults[3] == 3 && allresults[4] == 4){
      this.setData({
        lock2:this.data.lock.push(1),
      });
      this.setData({
        lock2:this.data.lock.push(2),
      });
      this.setData({
        lock2:this.data.lock.push(3),
      });
      this.setData({
        lock2:this.data.lock.push(4),
      });
  }
  else if(allresults[0] == 2 && allresults[1] == 3 && allresults[2] == 4 && allresults[3] == 5 && allresults[4] == 2 || allresults[0] == 2 && allresults[1] == 3 && allresults[2] == 3 && allresults[3] == 4 && allresults[4] == 5 || allresults[0] == 2 && allresults[1] == 3 && allresults[2] == 4 && allresults[3] == 4 && allresults[4] == 5 || allresults[0] == 2 && allresults[1] == 3 && allresults[2] == 4 && allresults[3] == 5 && allresults[4] == 5 ){
    this.setData({
      lock2:this.data.lock.push(2),
    });
    this.setData({
    ...
    this.setData({
      lock2:this.data.lock.push(5),
    });
  }
  else if(allresults[0] == 1 && allresults[1] == 3 && allresults[2] == 4 && allresults[3] == 5 && allresults[4] == 6 || allresults[0] == 3 && allresults[1] == 3 && allresults[2] == 4 && allresults[3] == 5 && allresults[4] == 6 || allresults[0] == 3 && allresults[1] == 4 && allresults[2] == 4 && allresults[3] == 5 && allresults[4] == 6 || allresults[0] == 3 && allresults[1] == 4 && allresults[2] == 5 && allresults[3] == 5 && allresults[4] == 6 || allresults[0] == 3 && allresults[1] == 4 && allresults[2] == 5 && allresults[3] == 6 && allresults[4] == 6){
    this.setData({
      lock2:this.data.lock.push(3),
    });
    this.setData({
    ...
    this.setData({
      lock2:this.data.lock.push(6),
    });
  }
  else if(allresults[0] == 1 && allresults[1] == 2 && allresults[2] == 3 && allresults[3] == 4 && allresults[4] == 5){
    this.setData({
      lock2:this.data.lock.push(1),
    });
    this.setData({
  ...
  else if(allresults[0] == 2 && allresults[1] == 3 && allresults[2] == 4 && allresults[3] == 5 && allresults[4] == 6){
    this.setData({
      lock2:this.data.lock.push(2),
    });
    this.setData({
  ...
  if(len == 2){
      if(result[0] == result[1]){
        this.setData({
          lock2:this.data.lock.push(result[0]),
        });
        this.setData({
          lock2:this.data.lock.push(result[0]),
        });
        ...
        this.setData({
          lock2:this.data.lock.push(result[1]),
        });
        this.setData({
          lock2:this.data.lock.push(result[1]),
        });
